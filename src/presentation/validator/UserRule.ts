...
export const UserRule = {
  first_name: [
    { required: true, message:i18n.global.t("not_empty") + i18n.global.t("first_name"), trigger: "blur" },
  ],
  last_name: [
    { required: true, message:i18n.global.t("not_empty") + i18n.global.t("last_name"), trigger: "blur" },
  ],
  email: [
