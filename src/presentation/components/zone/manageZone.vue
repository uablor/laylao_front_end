...
// import { useProvince } from "@/presentation/composables/useProvince";
// import { useDistrict } from "@/presentation/composables/useDistrict";
import { Zone } from "@/domain/entities/zone.entity";
import { EnvironmentFilled } from "@ant-design/icons-vue";
// const { ProvinceList, fetchProvinceList } = useProvince();

// const { DistrictList, fetchDistrictList } = useDistrict();
...
watch(
  () => props.data,
  (value) => {
    if (value) Object.assign(formState, value);
