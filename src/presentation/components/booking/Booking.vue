  ...
  >
    <a-form layout="vertical" ref="formRef" :model="booking">
      ...
      <div
        ...
        class="text-center py-8 text-gray-400 border border-dashed border-gray-300 rounded-lg"
      >
        {{ $t("please add rooms") }}
      </div>
      ...
      >
        ...
        <div class="font-medium text-gray-600 mb-3">
  ...
  if (checkinDate) {
    ...
    if (checkout.isBefore(checkin) || checkout.isSame(checkin, "day")) {
      return Promise.reject(
        t("checkout_must_be_after_checkin") || "วันเช็คเอาท์ต้องหลังวันเช็คอิน"
      );
    }
  }
