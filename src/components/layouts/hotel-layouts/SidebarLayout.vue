...
const routeToMenuKey: Record<string, string> = {
  "admin-hotel.detailhotel": "menuitem-hotel",
  "admin-hotel.booking": "menuitem-list booking",
  "admin-hotel.user": "menuitem-user",
  "admin-hotel.dashboard": "menuitem-dashboard",
  "admin-hotel.zone": "menuitem-zone",
};
